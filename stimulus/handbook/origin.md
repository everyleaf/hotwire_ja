...
しかも、選ぶ必要もありません。 StimulusとTurboは、他の重いアプローチと組み合わせても効果的です。アプリケーションの80％が重たいアプローチを必要としない場合は、当社の2パックパンチ(Stimulus/Turbo)の使用をご検討ください。 そして、本当にメリットがある部分にだけ、重たいアプローチの導入を検討しましょう。
